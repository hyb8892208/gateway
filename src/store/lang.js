...
export default {
    ...
    save_order: language('Save Orders'),
    ...
    snmp_version_help: language('SNMP version help','Modify the selected SNMP version\'s parameters'),
    ...
    already_exists: language('Language Already exists', 'The language already exists'),
    fire_upload_help: language("File upload help","The format of the uploaded file is incorrect."),
    ...
    sip_overwrite_confirm: language('sip overwrite confirm'),
