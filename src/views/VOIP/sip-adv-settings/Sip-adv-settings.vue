                        ...
                        <el-row>
                                ...
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.udp_bind_port_help"></div>
                                            <span>{{lang.udp_bind_port}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="udp_bind_port" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.enable_tcp_help"></div>
                                            <span>{{lang.enable_tcp}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="enable_tcp" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.tcp_bind_port"></div>
                                            <span>{{lang.tcp_bind_port}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="tcp_bind_port" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.tcp_authentication_timeout_help"></div>
                                            <span>{{lang.tcp_authentication_timeout}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="tcp_authentication_timeout" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.tcp_authentication_limit_help"></div>
                                            <span>{{lang.tcp_authentication_limit}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="tcp_authentication_limit" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.enable_hostname_lookup_help"></div>
                                            <span>{{lang.enable_hostname_lookup}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="enable_hostname_lookup" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.subscribe_network_change_event_help"></div>
                                            <span>{{lang.subscribe_network_change_event}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="subscribe_network_change_event" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.match_external_address_locally_help"></div>
                                            <span>{{lang.match_external_address_locally}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="match_external_address_locally" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.dynamic_exclude_static_help"></div>
                                            <span>{{lang.dynamic_exclude_static}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="dynamic_exclude_static" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.externally_mapped_tcp_port_help"></div>
                                            <span>{{lang.externally_mapped_tcp_port}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="externally_mapped_tcp_port" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.external_address_help"></div>
                                            <span>{{lang.external_address}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="external_address" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.external_hostname_help"></div>
                                            <span>{{lang.external_hostname}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="external_hostname" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.hostname_refresh_internal_help"></div>
                                            <span>{{lang.hostname_refresh_internal}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="hostname_refresh_interval" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.start_of_rtp_port_range_help"></div>
                                            <span>{{lang.start_of_rtp_port_range}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="start_of_rtp_port_range" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.end_of_rtp_port_range_help"></div>
                                            <span>{{lang.end_of_rtp_port_range}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="end_of_rtp_port_range" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.rtp_timeout_help"></div>
                                            <span>{{lang.rtp_timeout}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="rtptimeout" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.strict_rfc_interpretation_help"></div>
                                            <span>{{lang.strict_rfc_interpretation}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="strict_rfc_interpretation" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.send_compact_headers_help"></div>
                                            <span>{{lang.send_compact_headers}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="send_compact_headers" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.sdp_owner_help"></div>
                                            <span>{{lang.sdp_owner}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="sdp_owner"></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.matching_priority_help"></div>
                                            <span>{{lang.matching_priority}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="matching_priority" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.hangup_cause_code_help"></div>
                                            <span>{{lang.hangup_cause_code}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="hangupcausecode" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.shrink_caller_id_help"></div>
                                            <span>{{lang.shrink_caller_id}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="shrink_caller_id" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.sip_from_help"></div>
                                            <span>{{lang.sip_from}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="sip_from" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.sip_to_help"></div>
                                            <span>{{lang.sip_to}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="sip_to" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.callee_id_help"></div>
                                            <span>{{lang.callee_id}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="callee_id_1" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.maximum_registration_expiry_help"></div>
                                            <span>{{lang.maximum_registration_expiry}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="maximum_registration_expiry" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.minimum_registration_expiry_help"></div>
                                            <span>{{lang.minimum_registration_expiry}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="minimum_registration_expiry" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.default_registration_expiry_help"></div>
                                            <span>{{lang.default_registration_expiry}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="default_registration_expiry" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.registration_timeout_help"></div>
                                            <span>{{lang.registration_timeout}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="registration_timeout" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.number_of_registration_attempts_help"></div>
                                            <span>{{lang.number_of_registration_attempts}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="number_of_registration_attemptsy" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.match_auth_username_help"></div>
                                            <span>{{lang.match_auth_username}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="match_auth_username" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.realm_help"></div>
                                            <span>{{lang.realm}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="realm" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.use_domain_as_realm_help"></div>
                                            <span>{{lang.use_domain_as_realm}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="use_domain_as_realm" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.always_auth_reject_help"></div>
                                            <span>{{lang.always_auth_reject}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="always_auth_reject" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.authenticate_options_requests_help"></div>
                                            <span>{{lang.authenticate_options_requests}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="authenticate_options_requests" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.allow_guest_calling_help"></div>
                                            <span>{{lang.allow_guest_calling}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="allow_guest_calling" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.premature_media_help"></div>
                                            <span>{{lang.premature_media}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="premature_media" style="width: 100%;">
                                            <el-option
                                                    v-for="item in yes_or_no_options"
                                                    :label="item.label"
                                                    :key="item.value"
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.directmedia_help"></div>
                                            <span>{{lang.directmedia}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-select v-model="direct_media" style="width: 100%;">
                                            <el-option
                        ...
                        <el-row>
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.tos_for_sip_packets_help"></div>
                                            <span>{{lang.tos_for_sip_packets}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="tos_for_sip_packets" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                            ...
                            <el-col :lg="12">
                                <el-form-item>
                                    <label slot="label">
                                        <el-tooltip placement="top" :open-delay=200>
                                            <div slot="content" v-html="lang.tos_for_rtp_packeds_help"></div>
                                            <span>{{lang.tos_for_rtp_packeds}}</span>
                                        </el-tooltip>:
                                    </label>
                                    <el-col :lg="18">
                                        <el-input v-model="tos_for_rtp_packets" ></el-input>
                                    </el-col>
                                </el-form-item>
                            </el-col>
                        </el-row>
