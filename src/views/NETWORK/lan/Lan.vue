                ...
                <el-row>
                    <el-col :lg="12">
                        <el-form-item>
                            ...
                            <el-col :lg="18">
                                <el-input v-model="address" :readonly="address_readonly"></el-input>
                            </el-col>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :lg="12">
                        <el-form-item>
                            ...
                            <el-col :lg="18">
                                <el-input v-model="netmask" :readonly="netmask_readonly"></el-input>
                            </el-col>
                        </el-form-item>
                    </el-col>
                </el-row>
                ...
                <el-row>
                    <el-col :lg="12">
                        <el-form-item>
                            ...
                            <el-col :lg="18">
                                <el-input v-model="gateway" :readonly="gateway_readonly"></el-input>
                            </el-col>
                        </el-form-item>
                    </el-col>
                </el-row>
            ...
            <el-row>
                <el-col :lg="12">
                    <el-form-item>
                        ...
                        <el-col :lg="18">
                            <el-checkbox v-model="reserved_sw"></el-checkbox>
                        </el-col>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                <el-col :lg="12">
                    <el-form-item>
                        ...
                        <el-col :lg="18">
                            <el-input v-model="reserved_ip" :readonly=true></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
            </el-row>
            ...
            <el-row>
                <el-col :lg="12">
                    <el-form-item>
                        ...
                        <el-col :lg="18">
                            <el-input v-model="reserved_mask" :readonly=true></el-input>
                        </el-col>
                    </el-form-item>
                </el-col>
            </el-row>
